...
import com.stacktivity.voiceproject.adapters.UsersAdapter
...
import com.stacktivity.voiceproject.util.signOut
...
class OpponentsActivity : BaseActivity() {
    ...
    override fun onResume() {
        super.onResume()
        val isIncomingCall = SharedPrefsHelper[EXTRA_IS_INCOMING_CALL, false]
    ...
    private fun initUserListView(users: ArrayList<QBUser>) {
    ...
    private fun startLoginService() {
        LoginService.start(this, SharedPrefsHelper.getCurrentUser()!!)
    }
