...
import com.stacktivity.voiceproject.util.loadUsersByPagedRequestBuilder
import com.stacktivity.voiceproject.utils.RingtonePlayer
import com.stacktivity.voiceproject.utils.WebRtcSessionManager
...
class IncomeCallFragment : Fragment(), Serializable, View.OnClickListener {
    ...
    private lateinit var opponentsIds: List<Int>
//    private var vibrator: Vibrator? = null  // TODO
    ...
    private lateinit var currentSession: QBRTCSession
    ...
    private fun initUI(view: View) {
        ...
        GlobalScope.launch {
            val callerUser = DbManager.getQbUserById(currentSession.callerID)
        ...
        GlobalScope.launch {
            ...
            activity!!.runOnUiThread {
                otherIncUsersTextView.text = getOtherIncUsersNames(usersFromDb)
        ...
        loadUsersByPagedRequestBuilder(object : QBEntityCallback<ArrayList<QBUser>> {
            override fun onSuccess(users: ArrayList<QBUser>, params: Bundle?) {
                GlobalScope.launch {
                    ...
                    val callerUser: QBUser? = DbManager.getQbUserById(currentSession.callerID)
                    activity!!.runOnUiThread {
...
//        vibrator = activity?.getSystemService(Context.VIBRATOR_SERVICE) as Vibrator?
        ...
        /*val vibrationCycle = longArrayOf(0, 1000, 1000)  // TODO
...
//        vibrator?.cancel()
    ...
    private fun getOtherIncUsersNames(usersFromDb: ArrayList<QBUser>): String {
        var result = ""
        opponentsIds?.let {
