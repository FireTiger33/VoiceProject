...
-keep class com.quickblox.videochat.webrtc.view.QBRTCSurfaceView  # TODO delete (list_item_opponent_from_call.xml)

-keep class org.jivesoftware.** { *; }

#sample chat
-keep class androidx.compat.*
...
#-keep class com.stacktivity.voiceproject.services.fcm.PushListenerService